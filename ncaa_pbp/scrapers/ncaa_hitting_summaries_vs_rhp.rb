...
ncaa_player_summaries = CSV.open("csv/ncaa_player_hitting_summaries_vs_rhp_#{year}_#{division}.csv","w",{:col_sep => "\t"})
ncaa_team_summaries = CSV.open("csv/ncaa_team_hitting_summaries_vs_rhp_#{year}_#{division}.csv","w",{:col_sep => "\t"})
