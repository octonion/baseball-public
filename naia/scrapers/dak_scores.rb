...
conferences = CSV.read("players/conferences.csv")
...
(first_year..last_year).each do |year|
  ...
  games = CSV.open("players/naia_dak_games_#{year}.csv","w")
  ...
  conferences.each do |conference|
    ...
    row = []
    game_date = nil
    page.parser.xpath("//table[@id='ctl00_websyncContentPlaceHolder_scheduleDataList']").each do |t|
